        ...
        function harvestAllOpenYksUnitForms(excludeUnitId) {
            ...
            yksUnits.forEach(u => { if (!u.saved && u.id !== excludeUnitId) harvestYksUnitForm(u.id); });
        }
        ...
        function renderYks(excludeUnitId) {
            harvestAllOpenYksUnitForms(excludeUnitId);
